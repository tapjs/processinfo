...
"--loader" "{LOADER ABS}" "--no-warnings=ExperimentalLoader"
`
...
"--loader={LOADER REL}" "--no-warnings=ExperimentalLoader"
`
...
"--import=whatever" "--" "--loader={LOADER URL}" "--loader={LOADER URL}" "--no-warnings=ExperimentalLoader"
`
...
"--import" "{IMPORT REL}" "--loader={LOADER URL}" "--no-warnings=ExperimentalLoader"
`

exports[`test/node-options-env.ts TAP no require.register available import absolute > import absolute 1`] = `
"--import" "{IMPORT ABS}" "--loader={LOADER URL}" "--no-warnings=ExperimentalLoader"
`

exports[`test/node-options-env.ts TAP no require.register available import multiple times > import multiple times 1`] = `
"--import" "file://{IMPORT ABS}" "--import={IMPORT REL}" "--import={IMPORT ABS}" "--import" "file://{IMPORT ABS}" "--import={IMPORT REL}" "--import={IMPORT ABS}" "--loader={LOADER URL}" "--no-warnings=ExperimentalLoader"
`

exports[`test/node-options-env.ts TAP no require.register available import not found > import not found 1`] = `
"--import" "not foud" "--loader={LOADER URL}" "--no-warnings=ExperimentalLoader"
`
...
"--import" "--loader={LOADER URL}" "--no-warnings=ExperimentalLoader"
`
