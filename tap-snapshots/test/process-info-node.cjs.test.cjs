...
{"root":{"children":["parent"],"files":["root.txt","shared.txt"],"uuid":"root","root":"root"},"parent":{"parent":"root","children":["child","child2"],"files":["parent.txt","shared.txt"],"uuid":"parent","root":"root"},"child":{"parent":"parent","files":["child.txt","shared.txt"],"root":"root","uuid":"child"},"child2":{"parent":"parent","files":["child2.txt","parent.txt"],"externalID":"child2-eid","root":"root","uuid":"child2"}}
`

exports[`test/process-info-node.cjs TAP basic instance stuff order=child,child2,parent,root > before linking 1`] = `
{"root":{"files":["root.txt","shared.txt"],"uuid":"root"},"parent":{"files":["parent.txt","shared.txt"],"uuid":"parent"},"child":{"files":["child.txt","shared.txt"],"uuid":"child"},"child2":{"files":["child2.txt","parent.txt"],"externalID":"child2-eid","uuid":"child2"}}
`
...
{"root":{"children":["parent"],"files":["root.txt","shared.txt"],"uuid":"root","root":"root"},"parent":{"parent":"root","children":["child2","child"],"files":["parent.txt","shared.txt"],"uuid":"parent","root":"root"},"child":{"parent":"parent","files":["child.txt","shared.txt"],"root":"root","uuid":"child"},"child2":{"parent":"parent","files":["child2.txt","parent.txt"],"externalID":"child2-eid","root":"root","uuid":"child2"}}
`
